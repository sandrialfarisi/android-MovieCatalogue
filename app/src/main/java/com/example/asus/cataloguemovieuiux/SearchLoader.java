...
public class SearchLoader extends AsyncTaskLoader<ArrayList<MovieItems>> {
    ...
    public SearchLoader(final Context context, String kumpulanMovie){
        super(context);
        onContentChanged();
    ...
    public ArrayList<MovieItems> loadInBackground() {
        ...
        String url = "http://api.themoviedb.org/3/search/movie?api_key="+API_KEY+"&language=en-US&query="+mKumpulanMovie;
